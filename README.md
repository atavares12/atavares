...
$
$ # Start the home - custom port
$ # python manage.py runserver 0.0.0.0:<your_port>
$
$ # Access the web home in browser: http://127.0.0.1:8000/
```
...
< PROJECT ROOT >
   |
   |-- core/                               # Implements home logic and serve the static assets
   |    |-- settings.py                    # Django home bootstrapper
   |    |-- wsgi.py                        # Start the home in production
   ...
   |
   |-- home/                                # A simple home that serve HTML files
   |    |
